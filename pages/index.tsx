  ...
  return (
    <>
      ...
      <div className="toolbar">
        <p className="intro">Ein Gebot kann NICHT zurückgezogen werden! Nicht nachvollziehbare Gebote werden gelöscht.<br/>Sollten Sie bei der Übergabe des Trikots (Sportfest FC Sonntag) nicht anwesend sein, bitten wir Sie, beim Gebot Ihre Telefonnummer und E-Mail-Adresse anzugeben.</p>
